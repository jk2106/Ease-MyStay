...
//	public Booking bookRoom(@RequestBody Booking booking,@PathVariable int room_id) {
//		return this.userService.reserveRoom(booking,room_id);
//	}
//	
...
//		return this.userService.bookRoom(room_id,room);
//	}
//}
